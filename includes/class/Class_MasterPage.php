...
class MasterPage {
    ...
    /**
     * Custom page thumb section.
     * @var String
     */
    private $_customThumbSection;
    ...
    /**
     * Sets the custom Thumb part on this page.
     * @param String $customThumbSection The custom part of the thumb part on the page.
     */
    public function setcustomThumbSection($customThumbSection) {
        $this->_customThumbSection = $customThumbSection;
    }

    /**
     * Gets current set custom thumb left contents.
     * @return String
     */
    public function getCustomThumbSection() {
        return $this->_customThumbSection;
    }
...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body>
        ...
        <div id="main_container">
            ...
            <div class="main_left">
                <?php echo $this->_customThumbSection; ?>
            </div>

            <div class="main_page">
                <?php echo '<h1>' . $this->_title . '</h1>'; ?>
