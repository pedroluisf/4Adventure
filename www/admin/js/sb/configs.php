...
include("/opt/lampp/htdocs/MultiBrandsOnline/includes/class/Config.php");

// absolute path to your public_html directory
$PUBLIC_HTML_DIR = ROOT;

// relative path to your uploads directory";
$REL_UPLOAD_DIR = "uploads/";
...
$DIRS = array
(
	//array('title'=>"Text images",	'dir'=>"uploads/text/"),
	array('title'=>"Gallery",'dir'=>$REL_UPLOAD_DIR),
);
/*
...
(
	...
	'mthumb' =>	array('title'=>"",	 	'dir' => ".".$REL_UPLOAD_DIR,	'ext'=>"png",'width' => 100,'height' => 100,'mask' => false, 'scale'=>"crop",   'bg'=>"FFFFFF"),
	...
	'gthumb' =>	array('title'=>"Gallery thumb",	'dir' => ".".$REL_UPLOAD_DIR,	'ext'=>"png",'width' => 160,'height' => 100,'mask' => false, 'scale'=>"addbg",'bg'=>"FFFFFF"),
);
